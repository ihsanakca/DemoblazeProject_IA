...
public class Login_stepDefs {
    ...
    public void verify_welcome(String expectedUsername) {
        productPage.verifyLogin(expectedUsername);
    }

    @When("The user enters username {string} and password {string} click login button")
    public void the_user_enters_username_and_password_click_login_button(String username, String password) {
